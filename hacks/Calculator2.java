...
public class Calculator2 {
    ...
    public static void main(String[] args){
        Calculator2 simpleMath = new Calculator2("200 + 10 ^ 3");
        System.out.println("\nSimple Math\n" + simpleMath);

        Calculator2 parenthesisMath = new Calculator2("(100 + 200) ^ 3");
        System.out.println("\nParenthesis Math\n" + parenthesisMath);

        Calculator2 fractionMath = new Calculator2("100.2 - 99.3");

        Calculator2 allMath = new Calculator2("200 % 300 + 5 + 300 / 200 + 1 * 100");
        System.out.println("\nAll Math\n" + allMath);

        Calculator2 allMath2 = new Calculator2("200 % (300 + 5 + 300) / 200 + 1 * 100");
        System.out.println("\nAll Math2\n" + allMath2);

        Calculator2 power = new Calculator2("2 ^ 3");
        System.out.println("\nPower Math\n" + power);
      ...
      Calculator2 allMath3 = new Calculator2(i);
      System.out.println("\nCalculated Math\n" + allMath3);
    }
