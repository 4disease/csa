  ...
  public static void runMenu(Menu current){
    ...
    public static void main(String[] args) {
      ...
      MenuRow[] rows1 = new MenuRow[]{
                new MenuRow("Exit", () -> main(null)),
                new MenuRow("Challenge 1", () -> QueueTester.main(null)),
        new MenuRow("Challenge 2", () -> MergeTester.main(null)),
        new MenuRow("Challenge 3", () -> StackTester.main(null))
        };

      MenuRow[] rows2 = new MenuRow[]{
        new MenuRow("Exit", () -> main(null)),
        new MenuRow("Calculator", () -> Calculator2.main(null))
      };
