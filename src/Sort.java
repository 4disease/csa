...
//        this.timeElapsed = Duration.between(start, end);
   ...
   static void insertionSort(int arr[])
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Nanoseconds count: " + time/1000000000.0 );
        System.out.println("Average: " + time /(1000000000.0*12));
        System.out.println("Min: " + minTime/1000000000.0 );
        System.out.println("Max: " + maxTime/1000000000.0 );
        System.out.println( );
        time =0;
        count =0;
        array = new int[SIZE];
